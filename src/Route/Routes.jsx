...
// GENERALE GESITON ROLES
import Roles from "../Components/Accueil/index";

// GESTION PRESENCES
import EmploiDuTemps from "../Components/Enseignant/EmploiDuTemps";
import Presences from "../Components/Enseignant/Presences/GestionPresences";
import RapportPresences from "../Components/Enseignant/Presences/RapportPresences";

// GESTION NOTES
import SaisieNotes from "../Components/Enseignant/Notes/SaisieNotes";
import SaisieNotes2 from "../Components/Enseignant/Notes/SaisieNotes2";
import ConsultationNotes from "../Components/Enseignant/Notes/ConsultationNotes";

// ADMINISTRATION

import DashboardGeneral from "../Components/Administration/DashboardGeneral";
import GestionEvaluation from "../Components/Administration/GestionEvalutation";
import GestionClasses from "../Components/Administration/GestionClasses";
import GestionSalles from "../Components/Administration/GestionSalles";
import GestionCours from "../Components/Administration/GestionCours";
import MaquettePedagogique from "../Components/Administration/MaquettePedagogique";

export const routes = [
  
  { path: `${process.env.PUBLIC_URL}/roles/:layout`, Component: <Roles /> },

  // ADMINISTRATION
  
  { path: `${process.env.PUBLIC_URL}/administration/dashboard-general/:layout`, Component: <DashboardGeneral /> },
  { path: `${process.env.PUBLIC_URL}/administration/gestion-evaluation/:layout`, Component: <GestionEvaluation /> },
  { path: `${process.env.PUBLIC_URL}/administration/gestion-classes/:layout`, Component: <GestionClasses /> },
  { path: `${process.env.PUBLIC_URL}/administration/gestion-salles/:layout`, Component: <GestionSalles /> },
  { path: `${process.env.PUBLIC_URL}/administration/gestion-cours/:layout`, Component: <GestionCours /> },
  { path: `${process.env.PUBLIC_URL}/administration/maquette-pedagogique/:layout`, Component: <MaquettePedagogique /> },
  // ENSEIGNANT
  { path: `${process.env.PUBLIC_URL}/enseignant/emploi-du-temps/:layout`, Component: <EmploiDuTemps /> },
  { path: `${process.env.PUBLIC_URL}/enseignant/presences/:layout`, Component: <Presences /> },
  { path: `${process.env.PUBLIC_URL}/enseignant/rapport-presences/:layout`, Component: <RapportPresences /> },
  { path: `${process.env.PUBLIC_URL}/enseignant/saisienotes/:layout`, Component: <SaisieNotes /> },
  { path: `${process.env.PUBLIC_URL}/enseignant/saisienotes2/:layout`, Component: <SaisieNotes2 /> },
  { path: `${process.env.PUBLIC_URL}/enseignant/consultation-saisienotes/:layout`, Component: <ConsultationNotes /> },
