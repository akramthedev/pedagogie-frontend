export const MENUITEMS = [
    ...
    Items: [
      {
        ...
        active: false,
        children: [
          { path: `${process.env.PUBLIC_URL}/enseignant/presences`, type: "link", title: "Suivi des Présences" },
          // { path: `${process.env.PUBLIC_URL}/enseignant/rapport-presences`, type: "link", title: "Rapport de Présences" },
        ],
      },
      // {
      //   title: "Notes",
      ...
      //   active: false,
      //   children: [
      //     { path: `${process.env.PUBLIC_URL}/enseignant/saisienotes`, type: "link", title: "Saisie des Notes" },
      //     { path: `${process.env.PUBLIC_URL}/enseignant/consultation-saisienotes`, type: "link", title: "Consultation des Notes" },
      //   ],
      // },
      // { path: `${process.env.PUBLIC_URL}/app/task`, icon: "task", type: "link", title: "Génération des Bulletins" },
      // { path: `${process.env.PUBLIC_URL}/app/task`, icon: "task", type: "link", title: "Statistiques" },
    ],
  },
  // Enseignant
  {
  ...
  //         { path: `${process.env.PUBLIC_URL}/table/datatable`, type: "link", title: "Create New" },
  //       ],
  //     },
