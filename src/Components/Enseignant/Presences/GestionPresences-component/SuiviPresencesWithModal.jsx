...
import { Media, Modal, ModalHeader, ModalBody, ModalFooter, Dropdown, DropdownToggle, DropdownMenu, DropdownItem } from "reactstrap";
import user1 from "../../../../assets/images/user/1.jpg"; // Image par défaut pour les photos
...
const studentTableColumns = (
  ...
  },
  {
    ...
    cell: (row) => (
      <select
        className="form-select"
        value={row.comportement || "Sérieux"}
        onChange={(e) => handleBehaviorChange(row.Etd_Id, e.target.value)}
        style={{
          backgroundColor: getBehaviorColor(row.comportement || "Sérieux"),
          color: "#fff",
        }}
      >
  ...
  },
  {
    ...
    cell: (row) => {
      return (
        <Dropdown isOpen={row.dropdownOpen} toggle={() => handleToggleDropdown(row.Etd_Id)}>
          <DropdownToggle
            tag="button"
...
const DataTableComponent = ({ Cls_Id, Ens_Id, Mat_Id, Date_Presence }) => {
        ...
        <Modal isOpen={modalOpen} toggle={handleCloseModal}>
          ...
          <ModalBody>
                        <div className="text-center mb-3">
                            ...
                            <Image
                                attrImage={{
                                    src: selectedStudent.Etd_Photo || user1,  // Utiliser la photo de l'élève ou l'image par défaut
                                    alt: `${selectedStudent.Etd_Nom} ${selectedStudent.Etd_Prenom}`,
            ...
            <div>
              <p>
                <strong>Nom:</strong> {selectedStudent.Etd_Nom}{" "}
                {selectedStudent.Etd_Prenom}
              </p>
              <p>
                <strong>Matricule:</strong>{" "}
                {selectedStudent.Etd_Matricule || "Non précisé"}
              </p>
              <p>
                <strong>Date de naissance:</strong>{" "}
                {new Date(
                  selectedStudent.Etd_DateNaissance
                ).toLocaleDateString()}
              </p>
              <p>
                <strong>Lieu de naissance:</strong>{" "}
                {selectedStudent.Etd_LieuNaissance}
              </p>
              <p>
                <strong>Adresse:</strong> {selectedStudent.Etd_Adresse}
              </p>
              <p>
                <strong>Remarque:</strong> {selectedStudent.Etd_Remarque}
              </p>
            </div>
            ...
            <div>
              {/* <h5>Ecole</h5> */}
              <p>
                <strong>Nom de l'école:</strong>{" "}
                {selectedStudent.ecoleEtudiant?.Ecole_Nom}
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                {selectedStudent.classesEtudiant?.[0]?.AnneeClasse?.Cls_Nom}
              </p>
              <p>
                <strong>Année scolaire:</strong>{" "}
                {selectedStudent.classesEtudiant?.[0]?.AnneeClasse?.Ann_Id ||
                  "Non précisée"}
              </p>
            </div>
            ...
            <div>
              <h5>Comportement</h5>
              <p>{selectedStudent.comportement}</p>
            </div>

            <div>
              <h5>Retard</h5>
              <p>
                {selectedStudent.retard
                  ? `${selectedStudent.retardMinutes} minutes`
                  : "Aucun retard"}
              </p>
            </div>
            ...
            <div>
              <h5>Appréciation</h5>
              <p>{selectedStudent.appreciation || "Aucune appréciation"}</p>
            </div>
          </ModalBody>
          <ModalFooter>
